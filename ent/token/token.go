...
// ByTokenToAuthUserField orders the results by TokenToAuthUser field.
func ByTokenToAuthUserField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newTokenToAuthUserStep(), sql.OrderByField(field, opts...))
	}
}
func newTokenToAuthUserStep() *sqlgraph.Step {
