...
// AppendHosts appends s to the "hosts" field.
func (inu *IncludedNetworkUpdate) AppendHosts(s []string) *IncludedNetworkUpdate {
	inu.mutation.AppendHosts(s)
	return inu
}
...
func (inu *IncludedNetworkUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := inu.mutation.Hosts(); ok {
		_spec.SetField(includednetwork.FieldHosts, field.TypeJSON, value)
	}
	if value, ok := inu.mutation.AppendedHosts(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, includednetwork.FieldHosts, value)
		})
	}
...
// AppendHosts appends s to the "hosts" field.
func (inuo *IncludedNetworkUpdateOne) AppendHosts(s []string) *IncludedNetworkUpdateOne {
	inuo.mutation.AppendHosts(s)
	return inuo
}
...
func (inuo *IncludedNetworkUpdateOne) sqlSave(ctx context.Context) (_node *IncludedNetwork, err error) {
	...
	if value, ok := inuo.mutation.AppendedHosts(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, includednetwork.FieldHosts, value)
		})
	}
