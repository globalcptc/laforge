...
func (*ScheduledStep) scanValues(columns []string) ([]any, error) {
...
func (ss *ScheduledStep) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the ScheduledStep.
// This includes values selected through modifiers, order, etc.
func (ss *ScheduledStep) Value(name string) (ent.Value, error) {
...
func (ss *ScheduledStep) QueryEnvironment() *EnvironmentQuery {
	return NewScheduledStepClient(ss.config).QueryEnvironment(ss)
}
...
func (ss *ScheduledStep) Update() *ScheduledStepUpdateOne {
	return NewScheduledStepClient(ss.config).UpdateOne(ss)
}
