...
func (a *Ansible) NamedUsers(name string) ([]*User, error) {
...
func (a *Ansible) appendNamedUsers(name string, edges ...*User) {
	if a.Edges.namedUsers == nil {
