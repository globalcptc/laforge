...
func (stu *ServerTaskUpdate) SetNillableType(s *servertask.Type) *ServerTaskUpdate {
	if s != nil {
		stu.SetType(*s)
	}
	return stu
...
// SetNillableType sets the "type" field if the given value is not nil.
func (stuo *ServerTaskUpdateOne) SetNillableType(s *servertask.Type) *ServerTaskUpdateOne {
	if s != nil {
		stuo.SetType(*s)
	}
	return stuo
