...
func (as *AgentStatus) QueryAgentStatusToProvisionedHost() *ProvisionedHostQuery {
	return NewAgentStatusClient(as.config).QueryAgentStatusToProvisionedHost(as)
}
...
func (as *AgentStatus) QueryAgentStatusToProvisionedNetwork() *ProvisionedNetworkQuery {
	return NewAgentStatusClient(as.config).QueryAgentStatusToProvisionedNetwork(as)
}
...
func (as *AgentStatus) QueryAgentStatusToBuild() *BuildQuery {
	return NewAgentStatusClient(as.config).QueryAgentStatusToBuild(as)
}
