...
func (s *Status) QueryStatusToBuild() *BuildQuery {
	return NewStatusClient(s.config).QueryStatusToBuild(s)
}
...
func (s *Status) QueryStatusToProvisionedNetwork() *ProvisionedNetworkQuery {
	return NewStatusClient(s.config).QueryStatusToProvisionedNetwork(s)
}
...
func (s *Status) QueryStatusToProvisionedHost() *ProvisionedHostQuery {
	return NewStatusClient(s.config).QueryStatusToProvisionedHost(s)
}
...
func (s *Status) QueryStatusToServerTask() *ServerTaskQuery {
	return NewStatusClient(s.config).QueryStatusToServerTask(s)
}
...
func (s *Status) QueryStatusToAdhocPlan() *AdhocPlanQuery {
	return NewStatusClient(s.config).QueryStatusToAdhocPlan(s)
}
