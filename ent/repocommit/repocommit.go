...
// ByRepoCommitToRepositoryField orders the results by RepoCommitToRepository field.
func ByRepoCommitToRepositoryField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newRepoCommitToRepositoryStep(), sql.OrderByField(field, opts...))
	}
}
func newRepoCommitToRepositoryStep() *sqlgraph.Step {
