...
// ByDiskToHostField orders the results by DiskToHost field.
func ByDiskToHostField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newDiskToHostStep(), sql.OrderByField(field, opts...))
	}
}
func newDiskToHostStep() *sqlgraph.Step {
