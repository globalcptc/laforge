...
type BuildCommitEdges struct {
	...
	namedBuildCommitToServerTask map[string][]*ServerTask
	namedBuildCommitToPlanDiffs  map[string][]*PlanDiff
}
...
func (bc *BuildCommit) QueryBuildCommitToBuild() *BuildQuery {
	return NewBuildCommitClient(bc.config).QueryBuildCommitToBuild(bc)
}
...
func (bc *BuildCommit) QueryBuildCommitToServerTask() *ServerTaskQuery {
	return NewBuildCommitClient(bc.config).QueryBuildCommitToServerTask(bc)
}
...
func (bc *BuildCommit) QueryBuildCommitToPlanDiffs() *PlanDiffQuery {
	return NewBuildCommitClient(bc.config).QueryBuildCommitToPlanDiffs(bc)
}
...
// NamedBuildCommitToServerTask returns the BuildCommitToServerTask named value or an error if the edge was not
// loaded in eager-loading with this name.
func (bc *BuildCommit) NamedBuildCommitToServerTask(name string) ([]*ServerTask, error) {
	if bc.Edges.namedBuildCommitToServerTask == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := bc.Edges.namedBuildCommitToServerTask[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (bc *BuildCommit) appendNamedBuildCommitToServerTask(name string, edges ...*ServerTask) {
	if bc.Edges.namedBuildCommitToServerTask == nil {
		bc.Edges.namedBuildCommitToServerTask = make(map[string][]*ServerTask)
	}
	if len(edges) == 0 {
		bc.Edges.namedBuildCommitToServerTask[name] = []*ServerTask{}
	} else {
		bc.Edges.namedBuildCommitToServerTask[name] = append(bc.Edges.namedBuildCommitToServerTask[name], edges...)
	}
}

// NamedBuildCommitToPlanDiffs returns the BuildCommitToPlanDiffs named value or an error if the edge was not
// loaded in eager-loading with this name.
func (bc *BuildCommit) NamedBuildCommitToPlanDiffs(name string) ([]*PlanDiff, error) {
	if bc.Edges.namedBuildCommitToPlanDiffs == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := bc.Edges.namedBuildCommitToPlanDiffs[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (bc *BuildCommit) appendNamedBuildCommitToPlanDiffs(name string, edges ...*PlanDiff) {
	if bc.Edges.namedBuildCommitToPlanDiffs == nil {
		bc.Edges.namedBuildCommitToPlanDiffs = make(map[string][]*PlanDiff)
	}
	if len(edges) == 0 {
		bc.Edges.namedBuildCommitToPlanDiffs[name] = []*PlanDiff{}
	} else {
		bc.Edges.namedBuildCommitToPlanDiffs[name] = append(bc.Edges.namedBuildCommitToPlanDiffs[name], edges...)
	}
}
