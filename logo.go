...
var MonoLogo = []string{
	...
	fmt.Sprintf("  <_______________________________-                         [AUTHOR] %s  ", strings.Join(AuthorHandles, ",")),
	"dP    ~~~~~~~-----__     ^    __-                                              ",
	"88                     _' `_      88888888b                                    ",
...
var ColorLogo = []string{
	...
	boldb("  <_______________________________-                         %s%s%s %s  ", boldg("["), britw("AUTHOR"), boldg("]"), boldr(strings.Join(AuthorHandles, ","))),
